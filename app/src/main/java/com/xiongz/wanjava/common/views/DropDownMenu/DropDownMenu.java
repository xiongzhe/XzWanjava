package com.xiongz.wanjava.common.views.DropDownMenu;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mUpDrawable = new IconDrawable(getContext(), SfaIcons.ic_popup_up).colorRes(R.color.colorPrimary).actionBarSize();
        mUpDrawable.setBounds(0, 0 , dpTpPx(7), dpTpPx(7));
        mDownDrawable = new IconDrawable(getContext(), SfaIcons.ic_popup_down).colorRes(R.color.icon_gray).actionBarSize();
