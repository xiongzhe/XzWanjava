package com.xiongz.wanjava.common.upgrade.update;
...
public class UpdateManager {
    ...
    public void download(final Activity context, String url) {
        ...
        final String fileName = "wan.apk";
        final String fileStoreDir = FileUtil.SDCARD_ABSOLUTE_DIR + "/wan";
    ...
    public void installApk(Activity context, File file) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {//判读版本是否在7.0以上
            Uri apkUri = FileProvider.getUriForFile(Xz.getApplicationContext(), "com.xiongz.wanjava.fileProvider", file);
