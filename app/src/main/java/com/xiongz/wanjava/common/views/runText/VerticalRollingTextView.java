...
public class VerticalRollingTextView extends View {
    ...
    public void animationEnd() {
        ...
        mCurrentIndex++;
        //2.计算出正确的角标
        int count = mDataSetAdapter.getItemCount() == 0 ? 1 : mDataSetAdapter.getItemCount();
        mCurrentIndex = mCurrentIndex < mDataSetAdapter.getItemCount() ? mCurrentIndex : mCurrentIndex % count;
        //3.计算下一个待显示文字角标
        confirmNextIndex();
        //3.位置复位
