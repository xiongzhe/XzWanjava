 ...
 * @date 2021/8/31
 */
public class AskFragment extends JzFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void request() {
        String url = NetManager.getInstance().getUrl(NetParams.getPageUrl(ConstUrl.ASK_LIST_BY_TREE, mPage));
        RxNetClient.builder()
                .url(url)
                .build()
                .get()
