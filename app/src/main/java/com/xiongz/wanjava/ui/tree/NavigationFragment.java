...
import com.xiongz.wanjava.ui.tree.adapter.NavigationAdapter;
 ...
 * @date 2021/8/31
 */
public class NavigationFragment extends JzFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    // 消息数据列表
    private final List<NavigationEntity> mDatas = new ArrayList<>();
    // 刷新
    ...
    private void initList() {
        ...
        mAdapter = new NavigationAdapter(getProxyActivity(), R.layout.item_system, mDatas);
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, final int position) {
                ...
                NavigationEntity entity = mAdapter.getData().get(position);
            }
        });
    ...
    private void request() {
        String url = NetManager.getInstance().getUrl(ConstUrl.NAVIGATION_TREE);
        RxNetClient.builder()
                .url(url)
                .build()
                .get()
    ...
    private void parseData(String result) {
        ...
        List<NavigationEntity> datas = FastjsonUtil.parseArray(list, NavigationEntity.class);
